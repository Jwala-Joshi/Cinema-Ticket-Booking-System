...
Cinema Ticket Booking System is a web application built with React and Java Spring Boot, allowing users to browse, search, and book movie tickets seamlessly.
...
```zsh
git clone https://github.com/Jwala-Joshi/Cinema-Ticket-Booking-System.git
cd backend
```
...
For example, on a Windows, use the following command;
...
mysql> GRANT ALL PRIVILEGES ON cinema.* TO 'root'@'%';
