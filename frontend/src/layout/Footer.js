      ...
      {isHomePage && (
        <div className='p-8'>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8'>
            <div>
              <h3 className='text-red-600 text-lg font-bold mb-4 uppercase tracking-wider'>About Cinema</h3>
            ...
            <div>
              <h3 className='text-red-600 text-lg font-bold mb-4 uppercase tracking-wider'>Quick Links</h3>
              <ul className='space-y-2'>
                {['Home', 'Movies', 'Now Showing', 'Coming Soon', 'About Us', 'Contact'].map(link => (
                  <li key={link}>
                    <a href='#' className='text-sm hover:text-red-600 transition-all duration-300 hover:translate-x-1 inline-block'>{link}</a>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div>
              <h3 className='text-red-600 text-lg font-bold mb-4 uppercase tracking-wider'>Support</h3>
              <ul className='space-y-2'>
            ...
            <div>
              <h3 className='text-red-600 text-lg font-bold mb-4 uppercase tracking-wider'>Stay Updated</h3>
              <p className='text-sm mb-4'>Subscribe to get updates on new movies and exclusive offers!</p>
          ...
          <div className='border-t border-white/10 pt-6 mb-6'>
            ...
            <div className='flex justify-center gap-3 flex-wrap'>
              {['eSewa', 'Khalti', 'IME'].map(payment => (
                <div key={payment} className='px-4 py-2 bg-white/5 rounded border border-white/10 hover:border-red-600 hover:bg-white/10 transition-all duration-300 text-xs font-semibold'>{payment}</div>
              ))}
            </div>
          </div>
        </div>
      ...
      <div className='px-4 pb-8'>  
        <div className='border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4'>
          ...
          <div className='flex gap-6 text-sm flex-wrap justify-center'>
            <a href='#' className='hover:text-red-600 transition-colors duration-300'>Privacy</a>
            <a href='#' className='hover:text-red-600 transition-colors duration-300'>Terms</a>
            <a href='#' className='hover:text-red-600 transition-colors duration-300'>Sitemap</a>
          </div>
        </div>
      </div>
    </footer>
