        ...
        <>
          ...
          <div className='flex flex-col sm:flex-row justify-center items-center gap-4 mt-12'>
            <button
              ...
              className={`px-8 py-3 rounded-full font-semibold text-sm transition-all duration-300 ${page === 1
            ...
            <button
              ...
              className={`px-8 py-3 rounded-full font-semibold text-sm transition-all duration-300 ${page === totalPages
                  ? 'bg-gray-700 text-gray-500 cursor-not-allowed'
                  : 'bg-gradient-to-r from-red-600 to-red-700 text-white hover:from-red-500 hover:to-red-600 hover:shadow-lg hover:shadow-red-500/50 transform hover:-translate-y-0.5'
                }`}
